//nos importaremos la clase Trapecio que proviene del archivo trapecio.js
import Trapecio from "./trapecio.js";

function ejecutar(){

    const base_mayor= document.getElementById("inp_bma").value
    const base_menor= document.getElementById("inp_bma").value
    const altura= document.getElementById("inp_bma").value
